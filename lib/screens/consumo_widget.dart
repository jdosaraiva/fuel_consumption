...
class ConsumoCombustivelWidget extends StatefulWidget {
  const ConsumoCombustivelWidget({Key? key}) : super(key: key);

  @override
  ConsumoCombustivelWidgetState createState() =>
      ConsumoCombustivelWidgetState();
}

class ConsumoCombustivelWidgetState extends State<ConsumoCombustivelWidget> {
